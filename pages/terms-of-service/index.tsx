      ...
      <div className="flex flex-col">
        <div className="grid grid-cols-1 lg:grid-cols-2 w-full tracking-[2px] pt-10 lg:pt-48">
          ...
          <div className="flex flex-col items-center justify-center text-3xl lg:text-3xl">
            <span className="py-20 lg:py-0">Terms of Service</span>
          </div>
        </div>
        ...
        <div className="w-full p-10 lg:p-40">
          <div className="tab-content translations-content-item en visible" id="en">
            ...
            <h2 className="text-2xl py-4">Interpretation and Definitions</h2>
            <h3 className="text-xl py-4">Interpretation</h3>
            <p>
            ...
            <h3 className="text-xl py-4">Definitions</h3>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to Elham Mansiz
                  Resources, Elham Mansiz Resources, 2-2, Jalan Bpp 5/3, Pusat
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Elham Mansiz, accessible
                  from{" "}
                  <a
                    href="https://www.elhammansiz.com"
                    rel="external nofollow noopener"
                    target="_blank"
                  >
                    https://www.elhammansiz.com
                  </a>
                </p>
              </li>
              <li>
            ...
            <h2 className="text-2xl py-4">Acknowledgment</h2>
            <p>
            ...
            <h2 className="text-2xl py-4">Termination</h2>
            <p>
            ...
            <h2 className="text-2xl py-4">Limitation of Liability</h2>
            <p>
            ...
            <h2 className="text-2xl py-4">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
            <p>
            ...
            <h2 className="text-2xl py-4">Governing Law</h2>
            <p>
            ...
            <h2 className="text-2xl py-4">Disputes Resolution</h2>
            <p>
              If You have any concern or dispute about the Service, You agree to
              first try to resolve the dispute informally by contacting the
              Company.
            </p>
            <h2 className="text-2xl py-4">For European Union (EU) Users</h2>
            <p>
              If You are a European Union consumer, you will benefit from any
              mandatory provisions of the law of the country in which You are
              resident.
            </p>
            <h2 className="text-2xl py-4">United States Legal Compliance</h2>
            <p>
            ...
            <h2 className="text-2xl py-4">Severability and Waiver</h2>
            <h3 className="text-xl py-4">Severability</h3>
            <p>
            ...
            <h3 className="text-xl py-4">Waiver</h3>
            <p>
            ...
            <h2 className="text-2xl py-4">Translation Interpretation</h2>
            <p>
            ...
            <h2 className="text-2xl py-4">Changes to These Terms and Conditions</h2>
            <p>
            ...
            <ul>
              <li>
                <p>By email: elhammansiz8848@gmail.com</p>
              </li>
              <li>
                <p>By phone number: 60167138848</p>
              </li>
            </ul>
          </div>
        </div>
