...
const FooterMenu = () => {
    ...
    return (
        <div className="flex flex-col gap-10 tracking-[2px] px-6 lg:px-12 pt-12 mt-40 bg-gray-50 text-white"
            style={{ backgroundImage: `url('/blue_background.png')` }}>
            <div className="grid grid-cols-2 lg:grid-cols-4 text-2xl leading-[36px]">
                ...
                <div className="hidden lg:block flex flex-col gap-4 text-xs">
            ...
            <div className="lg:hidden block flex flex-col gap-4 text-xs">
                    <span>Have questions?</span>
                    <Link href="https://api.whatsapp.com/send?phone=60167138848&text=Hi%20Elham%20Mansiz!">
                        <Button className="rounded-none py-6 bg-sky-300 hover:bg-sky-400 w-full">
                            Contact us
            ...
            <div className="flex justify-between py-10 lg:text-sm text-xs">
